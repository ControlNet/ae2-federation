"""Verify V03 painted pixels, unchanged geometry and preserved V02 devices.
...
folder = Path(sys.argv[1]) if len(sys.argv) > 1 else ROOT / 'tools/blockbench/.local/v03-work'
...
print(f'V03: {len(tiles)} painted tiles match; block geometry/UVs unchanged; Router faces equivalent; {kept} Bridge/cable projects and all unrelated textures byte-identical to V02.')
