...
public record FederationDomainStateSnapshot(FederationDomainReference scope, long topologyRevision, long policyRevision, long dataRevision,
    ...
    public FederationDomainStateSnapshot {
